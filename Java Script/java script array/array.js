...
function exemplo1(){
	//sem array
	var time1 = "Corinthians";
	var time2 = "São Paulo";
	var time3 = "Palmeiras";
	var time4 = "Santos";
	document.write("<p>Sem array: " + time3 + "</p>");
	//com array
	...
	document.write("<p>Com array: " + times[2] + "</p>");
...
function exemplo2(){
	var nipes = ["Copas","Ouros","Espadas","Paus"];
	var faces = ["Az","2","3","4","5","6","7","8","9","10","Valete","Dama","Rei"];
	...
	document.write("<p>Carta sorteada: " + sorteio_face + " de " + sorteio_nipe + "</p>");
}
